            ...
            {products.map((product, idx) => (
              <Link href={`/products/${product.id}`} key={product.id || idx} className="block h-full">
                ...
                >
                  ...
                  {/* 产品图示占位框 */}
                  <div className="w-full h-44 bg-[#0a182b]/80 border border-[#2f55d4]/15 rounded-xl flex flex-col items-center justify-center relative overflow-hidden group-hover:border-[#2f55d4]/30 transition-all duration-300 mt-2 mb-6">
